...
# 추가할 파일 경로
file_path = File.join(current_dir, 'BobCam-iOS/BobCamAgent/BobCamAgent/EatingStatusBannerView.swift')
...
puts "EatingStatusBannerView.swift added to BobCamAgent target successfully!"